			...
			else if(mysqli_num_rows($q)==1)
			{
				echo "<table class='table table-bordered table-hover'>";
					echo "<tr style='background-color: #90c5f9;'>";
						...
						//table header
							...
							echo "<th>";  echo "Performance";   echo "</th>";
				echo "</tr>";
				...
				while($row=mysqli_fetch_assoc($q))
				{
					echo "<tr>";
						...
						?>
						<td><form action="fac_per.php" method="get">
                     <input type="hidden" name="fa_name" value="<?php echo $row['fa_name'] ?>" >
                     <input type="submit" name="view" value="View" class="btn btn-primary" style="font-size:1.5rem; margin-left: 20px;" >
                  </form>
						<?php
						echo "</tr>";
				}
		...
		else
		{
			...
			while($row=mysqli_fetch_assoc($res))
			{
				echo "<tr>";
                  ...
                  <form action="fac_per.php" method="get">
                     <input type="hidden" name="fa_name" value="<?php echo $row['fa_name'] ?>" >
                     <input type="submit" name="view" value="View" class="btn btn-primary" style="font-size:1.5rem; margin-left: 20px;" >
                  </form>
